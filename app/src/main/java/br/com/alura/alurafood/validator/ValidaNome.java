...
public class ValidaNome extends ValidadorPadrao {
    ...
    private static final String PADRAO_LETRAS_COM_OU_SEM_ACENTO = "[A-ZÀ-Ü]([a-zà-ü])*(?:(\\s[A-ZÀ-Ü]([a-zà-ü])*)*|\\s(d[aeiou])(s)?\\s[A-ZÀ-Ü]([a-zà-ü])*)*";
    ...
    public ValidaNome(EditText campo) {
        super(campo);
        setEmValidacao(nome -> valida(nome));
    }
